...
**4. สร้างฐานข้อมูลและบัญชี Admin เริ่มต้น**
รันสคริปต์นี้เพื่อสร้างไฟล์ฐานข้อมูล database.db และบัญชีผู้ดูแลระบบ (Admin) โดยอัตโนมัติ:

```python init-admin.py```

(บัญชีเริ่มต้น admin - Username: admin | Password: 123456)
